...
import (
	...
	"github.com/hi20160616/ms-vietnamplus/internal/job"
	"github.com/hi20160616/ms-vietnamplus/internal/server"
...
func main() {
	...
	g.Go(func() error {
		log.Printf("[%s] MS start at: %s",
			...
			configs.Data.MS["vietnamplus"].Addr)
	...
	// Job
	g.Go(func() error {
		log.Printf("[%s] Job is working", configs.Data.MS["vietnamplus"].Title)
